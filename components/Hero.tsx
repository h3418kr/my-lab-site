...
export default function Hero() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-brand-dark">
      {/* Background Effects */}
      ...
      <div className="z-10 text-center px-4 max-w-6xl mx-auto">
        <div className="mb-8 flex justify-center">
          <div className="p-3 border border-brand-lime/30 rounded-full backdrop-blur-md shadow-neon-lime bg-brand-dark/50">
